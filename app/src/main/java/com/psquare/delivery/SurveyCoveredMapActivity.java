...
public class SurveyCoveredMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_covered_map);
        gson = new Gson();
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        progress = new ProgressDialog(SurveyCoveredMapActivity.this);
