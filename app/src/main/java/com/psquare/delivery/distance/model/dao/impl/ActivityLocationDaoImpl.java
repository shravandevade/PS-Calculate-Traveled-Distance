package com.psquare.delivery.distance.model.dao.impl;
...
import com.psquare.delivery.distance.model.dao.Dao;
...
public class ActivityLocationDaoImpl extends Dao implements ActivityLocationDao {
    ...
    private static final String[] COLUMN_ARRAY = new String[]{COLUMN_ID, COLUMN_LATITUDE, COLUMN_LONGITUDE,
